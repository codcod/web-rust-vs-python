...
pub async fn create_author_book(
    ...
    match sqlx::query_as::<_, Book>(
        "INSERT INTO books (title, summary, publication_date, author_id) VALUES ($1, $2, $3, $4) RETURNING book_id, title, summary, publication_date, author_id"
    )
        ...
        .await
    {
        ...
        Err(_) => HttpResponse::InternalServerError().json("Failed to create a book and add it to author"),
